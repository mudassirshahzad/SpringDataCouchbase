...
import com.mudassirshahzad.entities.Area;
import com.mudassirshahzad.entities.Building;
import com.mudassirshahzad.services.BuildingService;
 ...
 *         20 Dec 2018
 */
public class BuildingServiceIntegrationTest extends CouchbaseSpringDataSampleApplicationTests {
    ...
    public void testSave() {
        ...
        List<Building> buildingList = buildingService.findByCompanyId(COMPANY_2);
        assertThat(buildingList.get(0), equalTo(building));
    }
